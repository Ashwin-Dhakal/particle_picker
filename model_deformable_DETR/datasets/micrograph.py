# ------------------------------------------------------------------------
# Deformable DETR  ----edits by Ashwin
...
class micrographDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder, ann_file, transforms, return_masks, cache_mode=False, local_rank=0, local_size=1):
        ...
        # ,                                             cache_mode=cache_mode, local_rank=local_rank, local_size=local_size) edits by Ashwin
...
def build(image_set, args):
    ...
    dataset = micrographDetection(img_folder, ann_file, transforms=make_micrograph_transforms(image_set), return_masks=args.masks) #edits by Ashwin
    return dataset
