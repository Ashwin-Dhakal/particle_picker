...
def get_args_parser():
    ...
    parser.add_argument('--num_queries', default=350, type=int,
    ...
    parser.add_argument('--thresh', default=0.0, type=float)   #edits by Ashwin, initially 0.5
...
def infer(images_path, model, postprocessors, device, output_dir):
    ...
    for img_sample in images_path:
        ...
        print(len(filename))
        print("processing start...{}".format(filename))
        orig_image = Image.open(img_sample)

        #edits by Ashwin
        rgb_image = Image.new("RGB", orig_image.size)
        ...
        img_save_path = os.path.join(output_dir, filename)
